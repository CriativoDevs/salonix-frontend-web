...
function MobileNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-primary border-t border-primary shadow-md flex justify-around items-center py-2 md:hidden z-50">
      ...
      >
        <div
          className={`absolute bottom-20 left-4 right-4 bg-primary rounded-xl shadow-2xl p-6 transition-all duration-300 transform ${
            isMenuOpen
        ...
        >
          <div className="mb-6 space-y-4">
            <Link
              ...
              className="flex items-center gap-3 rounded-md px-2 py-1 transition hover:bg-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-300"
            ...
            {expandedLinks.map(({ to, icon: IconComponent, label }) => {
              ...
              return (
                <NavLink
                  ...
                  to={to}
                  onClick={() => setIsMenuOpen(false)}
                  className="flex flex-col items-center justify-center p-4 rounded-xl border border-primary hover:bg-secondary hover:border-brand-200 hover:shadow-md transition-all duration-200 group"
                >
                  ...
                  <span className="text-sm font-medium text-primary group-hover:text-gray-900 text-center">
                    {label}
                  </span>
                </NavLink>
              );
